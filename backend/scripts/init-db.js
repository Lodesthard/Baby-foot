...
async function initDB() {
	...
	await conn.query(
		`INSERT INTO seasons (name, start_date, is_active, base_k_factor, rank_multiplier, score_multiplier, duo_rank_multiplier, loss_multiplier, win_streak_multiplier, loss_streak_multiplier)
         SELECT 'Saison 1', CURDATE(), 1, 32.00, 1.50, 0.10, 1.30, 1.00, 0.05, 0.05
